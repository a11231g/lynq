...
export const LOAD = 'lynq/beerWithPizza/LOAD'
export const LOAD_SUCCESSFUL = 'lynq/beerWithPizza/Load_SUCCESSFUL'
export const LOAD_FAILURE = 'lyn1/beerWithPizza/LOAD_FAILURE'
...
export function * watchLoadWithPizzaSaga () {
  try {
    const beers = yield call(fetchBeer, 'food')
